...
testcontrasts(salary$region)

salary %>% 
  group_by(region) %>% 
  summarise(avg_salary = mean(teacher_salary, na.rm = TRUE))
...
nvm <- d_ind_t(m1=33.7, m2=28.9, sd1=4.69, sd2=4.32, n1=9, n2=12)
nvw <- d_ind_t(m1=33.7, m2=28.6, sd1=4.69, sd2=3.87, n1=9, n2=11)
nvs <- d_ind_t(m1=33.7, m2=27.2, sd1=4.69, sd2=3.89, n1=9, n2=16)
mvw <- d_ind_t(m1=28.9, m2=28.6, sd1=4.32, sd2=3.87, n1=12, n2=11)
mvs <- d_ind_t(m1=28.9, m2=27.2, sd1=4.32, sd2=3.89, n1=12, n2=16)
wvs <- d_ind_t(m1=28.6, m2=27.2, sd1=3.87, sd2=3.89, n1=11, n2=16)
