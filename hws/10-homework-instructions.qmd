...
First, spend a little time looking at the data. What do you notice about the different variables? What do you think might be useful to keep in mind as we run our analyses?
...
Identify a NEW question that you can ask using these data, conduct that analysis, create a figure, and write an APA-style summary interpreting the results. Make sure to tell me what your research question is. Your results do not have to be significant.
