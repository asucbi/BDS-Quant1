...
To receive full credit you *must* answer *all* parts of *all* questions below (both code and written answers).
...
Describe what the descriptive statistics and histogram suggest about the shape of the "Corruption" distribution. Is it normally distributed or skewed in one direction? How can you tell?
...
Write up a summary of what you found. Make sure to include information about which measure of central tendency is most appropriate given the distribution. Use the objects you created earlier to insert all of the descriptive values you calculated directly into your summary.

## Exercise 6:

Choose one of the [Tidy Tuesday](https://github.com/rfordatascience/tidytuesday/tree/main) datasets and find a **continuous** variable that you would like to examine. Repeat Exercises 1-5 for that variable. Make sure to include the year and title of that dataset (e.g., 2021 - Netflix Titles) in your summary. If you do not include the year and title you will lose points.
