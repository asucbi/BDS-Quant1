...
1.  Answer the question: Does Model 2 explain significantly more variance in the tendency to believe in conspiracy theories than Model 1?

2.  Report the change in SSE between Model 1 and Model 2.

3.  Provide an APA-style summary of your results (make sure it contains **all** necessary pieces, check lab for an example).
