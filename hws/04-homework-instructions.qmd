...
2.  Write out your interpretations of the overall model (both R<sup>2</sup> and the F-statistic) and EACH of the regression coefficients (e.g., $\beta_0$, $\beta_1$, $\beta_2$, etc ...).
