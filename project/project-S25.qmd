---
title: "BDS 505 (Statistical Methods) Final Project"
editor: 
  markdown: 
    wrap: sentence
---
...
**IMPORTANT: Your data analysis plan is a _preregistration_. This means that the data analysis plan should be completed _and approved by Jessica_ before you start working with the data at all. You can look at the data (and should include a `glimpse()` or similar in the submission) to see things like which variables the dataset contains, the scale of the variables, or the type of variables, but if any analyses are done prior to data analysis plan approval you will need to find a new dataset and create a new data analysis plan.**
...
-   A comprehensive results section (the bulk of your report), which includes:
    ...
    -   Results of the models you described in your data analysis plan, including for each model:
        ...
        -   Results of the statistical analysis, written out in APA Style
            -   This should include coefficients, _p_-values, effect sizes, confidence intervals, etc.
...
-   An APA-Style reference section that cites your dataset and any other references that you used (e.g., to motivate your research question). You should have *at least* three references (your data set and two others to motivate the research).
...
Research presentations will take place the final week of class (April 28th and 30th).
