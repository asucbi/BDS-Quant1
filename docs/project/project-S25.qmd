...
-   An introduction to your data (where it comes from, how it was collected, what it represents)
-   A clear description of each of the variables that you are using in your analyses, making sure to specify which are independent and dependent variables
...
Make sure that you are doing all analyses exactly as specified in your data analysis plan. If you would like to add additional analyses, that is fine. However, make sure to mention in your report that these analyses were not previously specified and explain why you want to do them (e.g., to further explore a significant effect that you found). Do not omit any analyses that are specified in your Data Analysis Plan.
