---
title: "Module 7: Lab Instructions"
format: html
editor: visual
---
...
```{r pop-income, echo=FALSE, message=FALSE, eval=FALSE}
...
```{r centered, echo=FALSE, message=FALSE, eval=FALSE}
...
```{r multi-regression, echo=FALSE, message=FALSE, eval=FALSE}
...
```{r effect-size, echo=FALSE, message=FALSE, eval=FALSE}
...
```{r z-scores, echo=FALSE, message=FALSE, eval=FALSE}
...
```{r stand-reg, echo=FALSE, message=FALSE, eval=FALSE}
