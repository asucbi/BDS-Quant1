...
# #first, create the centered income variable
...
ANSWER: predicted population for a state at mean income and mean winter temp

> **Question: How would you interpret the effect of income?**

ANSWER: for each 1SD increase in income, we expect population to increase by 1977 holding winter temp constant

> **Question: How would you interpret the effect of winter?**

ANSWER: for each 1SD increase in winter temp, we expect population to increase by 2465 holding income constant
...
ANSWER: intercept and slope (intercept because last time we only centered income), overall model fit, t-values, and p-values stay the same because we didn't change the underlying relations
...
> **Question: Do we have a problem with multicollinearity?**
